...
var Infinite = React.createClass({
  ...
  componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
    ...
    if (this.props.containerHeight !== prevProps.containerHeight) {
      var scrollTop = this.utils.getScrollTop();
      var _newApertureState = infiniteHelpers.recomputeApertureStateFromOptionsAndScrollTop(this.state, scrollTop);
      if (this.passedEdgeForInfiniteScroll(scrollTop) && !this.state.isInfiniteLoading) {
        this.setState(_extends({}, _newApertureState));
        this.onInfiniteLoad();
      }
    }
  },
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { ref: 'smoothScrollingWrapper', id: 'smoothScrollingWrapper', style: infiniteScrollStyles },
